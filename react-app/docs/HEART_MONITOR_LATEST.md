...
- Run ID: 2026-05-17T17-39-25-237Z
- Time: 2026-05-17T17:39:54.198Z
- Status: PASS
...
PASS src/__tests__/basicBookingSmoke.test.js
  basic booking smoke loop
    ...
    √ keeps dev bypass disabled unless explicitly enabled (14 ms)
...
File sizes after gzip:
  293.55 kB (+55 B)  build\static\js\main.5018bdcf.js
  ...
  18.68 kB           build\static\css\main.04384b49.css
...
(node:6720) [DEP0176] DeprecationWarning: fs.F_OK is deprecated, use fs.constants.F_OK instead
...
PASS src/__tests__/devAuthUiSmoke.test.js
  dev-auth UI smoke
    √ opens the protected service booking screen as a dev consumer and updates smart match (223 ms)
    √ opens the public service catalog with launch and recruitable services (79 ms)
    √ opens the protected worker dashboard as a dev worker and reaches completion-photo modal (90 ms)
    √ opens the protected field operator console as a dev field operator (76 ms)
Test Suites: 1 passed, 1 total
Tests:       4 passed, 4 total
Snapshots:   0 total
Time:        1.67 s, estimated 3 s
