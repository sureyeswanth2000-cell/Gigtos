...
export const SPECIAL_JOBS = [
  {
    ...
    subtypes: [
      { id: 'driver-with-car', label: 'Car Driver', icon: '🚗', desc: 'Driver who brings their own car' },
      { id: 'driver-only', label: 'Only Driver', icon: '🧑‍✈️', desc: 'Driver to operate your vehicle' },
      { id: 'driver-with-bike', label: 'Bike Driver', icon: '🏍️', desc: 'Bike rider for deliveries or errands' },
      { id: 'driver-with-mini-van', label: 'Mini Van', icon: '🚐', desc: 'Mini van driver for local transport' },
      { id: 'driver-with-private-bus', label: 'Private Bus', icon: '🚌', desc: 'Private bus driver for group transport' },
      { id: 'driver-with-bulldozer', label: 'Bulldozer Operator', icon: '🚜', desc: 'Bulldozer operator for earthwork' },
    ],
  },
  {
    id: 'painter',
