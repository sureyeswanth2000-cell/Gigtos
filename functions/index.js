    ...
    try {
      await db.runTransaction(async (transaction) => {
        ...
        const offerData = {
          ...
          areaId: quote.areaId || booking.areaId || '',
          serviceId: quote.serviceId || booking.serviceId || '',
          finalConsumerPrice: bookingNow.finalConsumerPrice || quote.finalConsumerPrice || 0,
          workerReceivable: bookingNow.workerReceivable || quote.workerReceivable || 0,
          bargainRequestedPrice: bookingNow.bargainRequestedPrice || null,
          bargainStatus: bookingNow.bargainStatus || null,
          demandLevel: quote.demandLevel || 'normal',
          explanationWorker: bookingNow.bargainRequestedPrice ? `Proposing bargain price from consumer: INR ${bookingNow.workerReceivable}` : (quote.explanationWorker || ''),
