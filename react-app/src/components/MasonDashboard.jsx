...
export default function MasonDashboard() {
  ...
  return (
    <div className="mason-dashboard">
      <div className="mason-dashboard-header">
        <h1>🧱 Mason Dashboard</h1>
        <p>Manage all job types and workers across your region.</p>
      </div>

      <div className="mason-dashboard-body">
        {/* Jobs Panel */}
        <div className="mason-jobs-panel">
            ...
            {filteredJobs.map((job) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="mason-job-count">{workerCount} workers</span>
                </button>
              );
            })}
          </div>
