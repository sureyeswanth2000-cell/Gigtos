...
- Run ID: 2026-05-16T18-38-51-685Z
- Time: 2026-05-16T18:39:35.417Z
- Status: PASS
...
PASS src/__tests__/basicBookingSmoke.test.js
  basic booking smoke loop
    √ runs consumer booking to worker completion photo to consumer rating and score event (5 ms)
    √ keeps dev bypass disabled unless explicitly enabled (11 ms)
...
File sizes after gzip:
  287.77 kB (+72 B)  build\static\js\main.85f23187.js
  ...
  17.49 kB (-12 B)   build\static\css\main.e4a337fb.css
...
(node:21324) [DEP0176] DeprecationWarning: fs.F_OK is deprecated, use fs.constants.F_OK instead
...
PASS Asset /Gigtos/static/js/main.85f23187.js - 200 application/javascript; charset=utf-8
PASS Asset /Gigtos/static/css/main.e4a337fb.css - 200 text/css; charset=utf-8
```
...
PASS src/__tests__/devAuthUiSmoke.test.js
  dev-auth UI smoke
    √ opens the protected service booking screen as a dev consumer and updates smart match (272 ms)
    √ opens the public service catalog with launch and recruitable services (77 ms)
    √ opens the protected worker dashboard as a dev worker and reaches completion-photo modal (111 ms)
    √ opens the protected field operator console as a dev field operator (78 ms)
Test Suites: 1 passed, 1 total
Tests:       4 passed, 4 total
Snapshots:   0 total
Time:        2.257 s, estimated 5 s
