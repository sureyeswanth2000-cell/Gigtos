...
- Run ID: 2026-05-17T15-05-38-159Z
- Time: 2026-05-17T15:06:11.640Z
- Status: PASS
...
PASS src/__tests__/basicBookingSmoke.test.js
  basic booking smoke loop
    ...
    √ keeps dev bypass disabled unless explicitly enabled (8 ms)
...
File sizes after gzip:
  292.02 kB (+51 B)  build\static\js\main.85e02c2b.js
  ...
  18.45 kB           build\static\css\main.f10f128a.css
...
(node:7420) [DEP0176] DeprecationWarning: fs.F_OK is deprecated, use fs.constants.F_OK instead
...
PASS Asset /Gigtos/static/js/main.85e02c2b.js - 200 application/javascript; charset=utf-8
PASS Asset /Gigtos/static/css/main.f10f128a.css - 200 text/css; charset=utf-8
```
...
PASS src/__tests__/devAuthUiSmoke.test.js
  dev-auth UI smoke
    ...
    √ opens the public service catalog with launch and recruitable services (73 ms)
    √ opens the protected worker dashboard as a dev worker and reaches completion-photo modal (107 ms)
    √ opens the protected field operator console as a dev field operator (84 ms)
Test Suites: 1 passed, 1 total
Tests:       4 passed, 4 total
Snapshots:   0 total
Time:        1.872 s, estimated 4 s
